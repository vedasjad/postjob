...
import 'package:postjob/features/jobs/presentation/controllers/job_post_controller.dart';
import 'package:postjob/features/jobs/presentation/controllers/jobs_controller.dart';
import 'package:postjob/features/jobs/presentation/screens/job_post_screen/widgets/form_field_container.dart';
import 'package:postjob/features/jobs/presentation/screens/job_post_screen/widgets/my_drop_down_button.dart';
import 'package:postjob/features/jobs/presentation/screens/job_post_screen/widgets/my_text_form_field.dart';
...
class JobPostScreen extends StatelessWidget {
  ...
  final JobPostController jobPostController = Get.find();
      ...
      builder: (jobsController) {
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            actions: [
              if (jobPostController.isUpdate.value)
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 8.0),
                  child: GestureDetector(
                    onTap: () {
                      jobsController.deleteJob(jobPostController.job!);
                      Get.back();
                    },
                    child: Image.asset(
                      AppAssets.delete,
                  ...
                  children: <Widget>[
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Material(
                              ...
                              child: InkWell(
                                onTap: () async {
                                  await jobPostController.uploadPDF();
                                },
                                child: Container(
                                  ...
                                  child: Text(
                                    jobPostController.isUpdate.value
                                        ? "Change"
                                        : "Upload",
                                    style: const TextStyle(
                                      color: Colors.white,
                      ...
                      (index) {
                        return FormFieldContainer(
                          ...
                          child: MyTextFormField(
                            ...
                            validator: (String? value) {
                              return jobPostController.validateUrl(
                    ...
                    ...List.generate(jobPostController.areFieldsExpanded.length,
                      ...
                      final double contentHeight =
                          jobPostController.areFieldsExpanded[index]
                              ? 140.0
                              : 0.0;
                              ...
                              child: SizedBox(
                                ...
                                child: MyTextFormField(
                                  ...
                                  onFieldSubmitted: (value) {
                                    if (index < 3) {
                                      jobPostController
                                          .setExpansionTrue(index + 1);
                                      screenScrollController.animateTo(
                                        screenScrollController.position.pixels +
                                            500,
                                        duration:
                          ...
                          child: GestureDetector(
                            onTap: () async {
                              for (int i = 0;
                                  i <
                                      jobPostController
                                          .areFieldsExpanded.length;
                                  i++) {
                                jobPostController.setExpansionTrue(i);
                              }

                              if (jobPostController.formKey.currentState!
                                  .validate()) {
                                jobPostController.isUpdate.value
                                    ? await jobsController.updateJob(
                                        Job(
                                          jobLocation: jobPostController
                                              .selectedJobLocation.value,
                                          companyName: jobPostController
                                              .companyWebsiteLinkController
                                              .text,
                                          jobType: jobPostController
                                              .selectedJobType.value,
                                          jobTitle: jobPostController
                                              .jobTitleController.text,
                                          benefits: jobPostController
                                              .benefitsController.text,
                                          companyWebsiteLink: jobPostController
                                              .companyWebsiteLinkController
                                              .text,
                                          contactLocation: jobPostController
                                              .contactLocationController.text,
                                          contactNumber: int.parse(
                                              jobPostController
                                                  .contactNumberController
                                                  .text),
                                          description: jobPostController
                                              .descriptionController.text,
                                          jobLink: jobPostController
                                              .jobLinkController.text,
                                          linkedinProfile: jobPostController
                                              .linkedinProfileController.text,
                                          resume: jobPostController
                                              .resumeController.text,
                                          role: jobPostController
                                              .roleController.text,
                                          salary: Salary(
                                            currency: jobPostController
                                                .selectedSalaryCurrency.value,
                                            amount: int.parse(jobPostController
                                                .salaryController.text),
                                          ),
                                          skillsAndRequirements: jobPostController
                                              .skillsAndRequirementsController
                                              .text,
                                          id: jobPostController.job!.id,
                                        ),
                                      )
